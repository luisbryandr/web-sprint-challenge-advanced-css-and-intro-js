...
function get20s(array){
  ...
  for(let i=0; i < array.length; i++){
    ...
    if(yearSplitArray[0] > 1900 && yearSplitArray[1] <2000){
      twentiesArtist.push(array[i]["name"]);
    // if(array[i].years.includes('1900 -2000')){

    //   return twentiesArtist.push(array[i].name)
    }
  }
  return twentiesArtist
}
...
function addArtist(array){
    array.push(...array, { 
      id: 20,
      name: 'Luis B Dominguez', 
      years: '1993 - Nov 22, 2021',
      genre: 'Web Design', 
      nationality: 'Ecuador',
      bio: 'I am a beginner here, free to explore and learning to like failing as fast and as much as possible so I can learn and build resilience'
    })
    return array
  }
